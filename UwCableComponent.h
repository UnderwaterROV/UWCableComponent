...
#include "UwCableComponent.generated.h"
...
//class CABLECOMPONENT_API UUwCableComponent : public UMeshComponent
...
class UUwCableComponent : public UMeshComponent
{
...
public:
	...
	/** How many segments the are locked in the spool */
	//UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Cable", meta=(ClampMin = "0", UIMin = "0", UIMax = "2000"))
	//int32 NumOfSpooledSegments;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cable Forces")
	float CableDampingCoef;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cable Forces")
	float CableRandomForceCoef;
